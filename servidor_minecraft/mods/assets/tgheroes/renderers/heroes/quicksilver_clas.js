extend("tgheroes:quicksilver");
loadTextures({
	"layer1": "tgheroes:x_men/quicksilver/quicksilver_clas_layer1",
	"layer2": "tgheroes:x_men/quicksilver/quicksilver_clas_layer2"
});
...
function initEffects(renderer) {
    speedster.init(renderer, "tgheroes:quicksilver_clas_trail");
	speedster_powers.init(renderer, "tgheroes:quicksilver_clas_trail", utils);
