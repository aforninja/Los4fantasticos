...
loadTextures({
    "layer1": "tgheroes:fantastic_4/doom/goddoom",
	"cape": "tgheroes:fantastic_4/doom/doctor_doom_god_cape",
	"lights": "tgheroes:blank",
	"blank": "tgheroes:blank",
    "tp_god": "tgheroes:fantastic_4/doom/doom_tp_god.tx.json",
});
...
function init(renderer) {
	...
	renderer.setTexture((entity, renderLayer) => {
            ...
            return timer < 0.01 ? "layer1" : timer < 0.7 && entity.getInterpolatedData("fiskheroes:teleport_timer") > 0 ? "tp_god" : timer < 0.7 && entity.getInterpolatedData("fiskheroes:teleport_timer") == 0 ? "tp_god" : "blank";
    });
...
function initEffects(renderer) {
	utils.bindCloud(renderer, "fiskheroes:telekinesis", "tgheroes:doom_god_telekinesis");
	...
	speedster_powers.init(renderer, "tgheroes:lightning_white");
	...
	var beam1 = renderer.createResource("BEAM_RENDERER", "tgheroes:doom_booster");
    var blue_fire = renderer.createResource("ICON", "fiskheroes:blue_fire_layer_%s");
    booster_boots = boosters.create(renderer, "rightLeg", true, color3, blue_fire, beam1).setOffset(0.0, 7.0, 2.0).setSize(1.5, 3.0);
