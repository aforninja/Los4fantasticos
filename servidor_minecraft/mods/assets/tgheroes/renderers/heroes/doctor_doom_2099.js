...
loadTextures({
    "layer1": "tgheroes:fantastic_4/doom/doom_2099",
	"cape": "tgheroes:fantastic_4/doom/doom_2099_cape",
	"lights": "tgheroes:fantastic_4/doom/2099_lights",
	"blank": "tgheroes:blank",
    "tp_2099": "tgheroes:fantastic_4/doom/doom_tp_2099.tx.json",
});
...
function init(renderer) {
	...
	renderer.setTexture((entity, renderLayer) => {
            ...
            return timer < 0.01 ? "layer1" : timer < 0.7 && entity.getInterpolatedData("fiskheroes:teleport_timer") > 0 ? "tp_2099" : timer < 0.7 && entity.getInterpolatedData("fiskheroes:teleport_timer") == 0 ? "tp_2099" : "blank";
    });
...
function initEffects(renderer) {
	...
	speedster_powers.init(renderer, "tgheroes:lightning_red");
    ...
    booster_boots = boosters.create(renderer, "rightLeg", true, color3, red_fire, beam1).setOffset(0.0, 7.0, 2.0).setSize(1.5, 3.0);
